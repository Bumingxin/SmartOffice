...
# Configuration
REPO_URL="https://github.com/Bumingxin/SmartOffice.git"
...
echo -e "${BLUE}================================================${NC}"
echo -e "${BLUE}    SmartOffice - 一键安装脚本       ${NC}"
echo -e "${BLUE}================================================${NC}"
...
echo -e "${GREEN}================================================${NC}"
echo -e "您现在可以访问 SmartOffice："
echo -e "本地访问:   http://localhost:${1:-3456}"
echo -e "网络访问:   http://$LOCAL_IP:${1:-3456}"
